...
- **RAG Capabilities**: The `knowledge.json` file serves a dual purpose. It is also fed directly into the system's LLM prompt as context, acting as the memory bank that allows the integrated AI chatbot to accurately answer questions about the portfolio owner.
