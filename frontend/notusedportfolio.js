const header = {
  ...
  const about = {
    ...
    description:
      'Welcome to my digital corner. I am thrilled to showcase my current and past projects, as well as provide insights into my educational journey and professional endeavors. Lets connect and explore opportunities together.',
